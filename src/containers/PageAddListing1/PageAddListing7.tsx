...
const PageAddListing7: FC<PageAddListing7Props> = () => {
	return (
		...
		>
			<>
				<div>
					<h2 className="text-2xl font-semibold">Фотографии квартиры</h2>
				...
				<div className="space-y-8">
					{/* <div>
						<span className="text-lg font-semibold">Обложка</span>
						<div className="mt-5 ">
					...
					{/* ----------------- */}
					<div>
						<span className="text-lg font-semibold">Фотографии квартиры</span>
						<div className="mt-5 ">
							<div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-neutral-300 dark:border-neutral-6000 border-dashed rounded-md">
								<div className="space-y-1 text-center">
									<svg
									...
									<div className="flex text-sm text-neutral-6000 dark:text-neutral-300">
										<label
											...
											className="relative cursor-pointer  rounded-md font-medium text-primary-6000 hover:text-primary-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-primary-500"
										>
											<span>Загрузите минимум 3 файла</span>
											<input
												id="file-upload-2"
												name="file-upload-2"
												type="file"
