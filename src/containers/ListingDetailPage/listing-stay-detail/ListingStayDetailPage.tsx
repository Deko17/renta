		...
		return (
			<div className="listingSection__wrap !space-y-6">
				...
				<h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold">
					Жилой комплекс Park Avenue 3\3
				</h2>
				...
				<div className="flex items-center space-x-4">
					...
					<span>
						...
						<span className="ml-1"> Астана, Казахстан</span>
					</span>
				</div>
			...
			<div className="listingSection__wrap">
				...
				<div className="flow-root">
					<div className="text-sm sm:text-base text-neutral-6000 dark:text-neutral-300 -mb-4">
						...
						<div className="p-4 flex justify-between items-center space-x-4 rounded-lgg">
				...
				<div className="aspect-w-5 aspect-h-5 sm:aspect-h-3 ring-1 ring-black/10 rounded-xl z-0">
					<div className="rounded-xl overflow-hidden z-0">
						<iframe
							...
							src="https://www.google.com/maps/embed/v1/place?key=AIzaSyAGVJfZMAKYfZ71nzL_v5i3LjTTWnCYwTY&q=Baiterek,Kazakhstan"
						></iframe>
					</div>
				</div>
			</div>
